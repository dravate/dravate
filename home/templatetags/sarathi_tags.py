...
from home.models import DravateLogo, DravateThankyou, FooterText
...
@register.simple_tag
def sarathidravatelogo():
   return DravateLogo.objects.first();

@register.simple_tag
def sarathidravatethankyou():
   return DravateThankyou.objects.first();
